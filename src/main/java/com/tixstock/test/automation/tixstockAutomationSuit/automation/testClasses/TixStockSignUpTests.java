...
import com.tixstock.test.automation.tixstockAutomationSuit.automation.tixstockPages.TixStockSignUp_PersonalDetails;
import com.tixstock.test.automation.tixstockAutomationSuit.automation.utilities.CommonUtilities;
...
public class TixStockSignUpTests extends TestBase {
    ...
    @Autowired
    TixStockSignUp_PersonalDetails personalDetailPage;

    WebDriverWait wait;
    By signUpButton,business_RadioButton;
    String tixStockUrl ,userName="BusinessAccount123", password="12345", firstName="SomeBusiness", lastName="123",email="somebusiness@gmail.com" ,phone="9876543211",
            companyName="Some Business Company", postalCode="123456", country="Spain",city="London", countyCode="+44", addressLine1= "Some Street", addressLine2="Some Block";
    ...
    public void beforeClass() {
        ...
        personalDetailPage = new TixStockSignUp_PersonalDetails(driver);
   ...
   // @AfterClass
    ...
    @Test(enabled = true, dependsOnMethods = {"TC01_Validate_SignUpPage_CreateAccountButton"})
